            ...
            <div class="w-full px-4 md:px-8 mb-4 lg:w-1/6 self-start">
                ...
                <ul>
                    <li class="flex items-center text-sm ">
                        ...
                        <span class="ml-2">
                            <a href="https://wa.me/6281326657545" class="text-white hover:text-white relative group">
                                WhatsApp
                                <span
            ...
            <div class="flex items-center justify-center mb-4 md:justify-between mx-12 md:gap-4">
                ...
                <div class="flex">
                    ...
                    <a href="#" target="_blank"
                        class="w-9 h-9  mr-3 rounded-full flex justify-center items-center border border-slate-300 text-white hover:border-blueRiung hover:bg-blueRiung ">
                        <svg width="25" height="25" role="img" viewBox="0 0 24 24" class="fill-current"
                    ...
                    <a href="#" target="_blank"
                        class="w-9 h-9  mr-3 rounded-full flex justify-center items-center border border-slate-300 hover:border-blueRiung hover:bg-blueRiung  text-white">
                        <svg width="22" height="22" role="img" viewBox="0 0 24 24" class="fill-current"
                            xmlns="http://www.w3.org/2000/svg">
                            <title>X</title>
                            <path
                    ...
                    <a href="#" target="_blank"
                        class="w-9 h-9  mr-3 rounded-full flex justify-center items-center border border-slate-300 hover:border-blueRiung hover:bg-blueRiung  text-white">
                        <svg width="25" height="25" role="img" class="fill-current" viewBox="0 0 24 24"
                            xmlns="http://www.w3.org/2000/svg">
                        ...
                        <a href="#" target="_blank"
                            class="w-9 h-9  mr-3 rounded-full flex justify-center items-center border border-slate-300  hover:border-blueRiung hover:bg-blueRiung  text-white">
                            <svg class="fill-current" width="25" height="25" role="img"
